    ...
    def run(self):
        ...
        for i in tqdm(range(int(self.sim_duration / self.sim_dt)), desc="Running simulation..."):
            ...
            if i % self.sim_decimation == 0:
                ...
                # print("i // self.sim_decimation",i)
                # print("i // self.sim_decimation",i // self.sim_decimation)
                ...
                print("last_action,",self.last_action.shape)
